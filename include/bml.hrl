...
-define(CORE_ATTRS, [<<"id">>, <<"title">>, <<"class">>, <<"style">>]).
-define(ATTR_VALUES, [
...
%%  <<"!DOCTYPE">>, %	Объявляет тип документа и предоставляет основную информацию для браузера — его язык и версия.
  {<<"a">>,
    [ <<"accesskey">>, <<"href">>, <<"name">>, <<"tabindex">>, <<"target">>]}, %	Создаёт гипертекстовые ссылки.
  ...
  {<<"img">>, [ <<"align">>, <<"alt">>, <<"border">>, <<"dynsrc">>, <<"height">>, <<"width">>, <<"hspace">>, <<"vspace">>, <<"ismap">>, <<"lowsrc">>, <<"name">>, <<"src">>, <<"tabindex">>, <<"usemap">>]},%	Встраивает изображения в HTML-документ с помощью атрибута src, значением которого является адрес встраиваемого изображения.
  {<<"input">>,
  ...
  {<<"td">>, [<<"align">>,  <<"background">>,  <<"bgcolor">>,  <<"char">>,  <<"colspan">>,  <<"height">>,<<"width">>,  <<"nowrap">>,  <<"rowspan">>,  <<"valign">> ]}, %	Создает ячейку таблицы.
  ...
  {<<"tr">>, [<<"align">>, <<"bgcolor">>, <<"char">>, <<"valign">>]}, %	Создает строку таблицы.
